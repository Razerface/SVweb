          ...
          <div>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <Mail className="h-6 w-6 text-[#0072c6] mt-1 mr-4" />
                <div>
                  <h3 className="font-semibold mb-1">Email</h3>
                  <p className="text-gray-600">svgac@telus.net</p>
                </div>
              </div>
              <div className="flex items-start">
                <Phone className="h-6 w-6 text-[#0072c6] mt-1 mr-4" />
                <div>
                  <h3 className="font-semibold mb-1">Phone</h3>
                  <p className="text-gray-600">+1 403-291-0144</p>
                </div>
              </div>
              <div className="flex items-start">
                <MapPin className="h-6 w-6 text-[#0072c6] mt-1 mr-4" />
                <div>
                  <h3 className="font-semibold mb-1">Facebook</h3>
                  <p className="text-gray-600">
                  https://www.facebook.com/svgac/<br />
                  </p>
                </div>
              </div>
            </div>
